...
public class GuiRenderedEvent extends Event {
    ...
    public GuiRenderedEvent(Minecraft minecraft, Screen screen, GuiGraphics guigraphics, int i, int j, float deltaFrameTime, boolean cancelled) {
